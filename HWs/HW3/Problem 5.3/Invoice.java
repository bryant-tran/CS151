...
public class Invoice
{
   ...
   */
   ...
   public String format(InvoiceFormatter formatter)
   {
      ...
      while (iter.hasNext())
         r = formatter.formatHeader() + formatter.formatLineItem(iter.next());
      return r + formatter.formatFooter();
   }
   
   public void increaseHammerCount()
   {
	   hammerCount++;
   }
   ...
   public static int getHammerCount()
   {
	   return hammerCount;
   }
   ...
   private static int hammerCount = 0;
